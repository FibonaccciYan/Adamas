...
def test_prefill_attention_correctness(dtype_str, qo_len, kv_len):
    ...
    k_code = torch.bucketize(hadamard_transform(k),   testController.thresholds, out_int32=True)
    ...
    HSA.utils.append_kvh(k, v, k_code_2bit, testController, 0)
    o_device = HSA.utils.prefill_forward(q, testController, 0)
