...
do
    ...
    do
        python3 bench_textgen.py --model $MODEL --context_len $context --decode_len 256 --token_budget $budget --iteration 1 --page_size 1 > "../test_results/${MODEL}/log_${budget}_${context}.log" 2>&1
    done
done